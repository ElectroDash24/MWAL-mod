...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.SADDLE.asItem())
                .pattern("LLL")
                .pattern("LIL")
                .pattern("S S")
                .define('L', Items.LEATHER.asItem())
                .define('I', Items.IRON_INGOT.asItem())
                .define('S', Items.STRING.asItem())
                .unlockedBy(getHasName(Items.LEATHER.asItem()),has(Items.LEATHER.asItem()))
                .save(pWriter);
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup, String pRecipeName) {
        ...
        while(var9.hasNext()) {
            ...
            SimpleCookingRecipeBuilder.generic(Ingredient.of(new ItemLike[]{itemlike}),
                    ...
                    .save(pFinishedRecipeConsumer, MWALmod.MODID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
